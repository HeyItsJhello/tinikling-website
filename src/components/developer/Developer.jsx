...
export default function Developer() {
  return (
    ...
    >
      <div style={{ maxWidth: "52rem", margin: "0 auto", padding: "0 clamp(1.25rem, 4vw, 2.5rem)" }}>
        ...
        >
          <div style={{ flex: 1, height: "1px", background: "rgba(218,160,109,0.18)" }} />
          <span style={{
            fontSize: "0.6rem",
            fontWeight: "800",
            ...
            <div style={{
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.parentElement.style.background = "rgba(218,160,109,0.06)";
                }}
              />
            </div>
          </div>
        ...
        >
          <p style={{
            ...
            "Why would you even check the very bottom right corner of the footer? How did you find me? Since you're here — hope you enjoy the site. It took a while."
          </p>
          <span style={{
            fontSize: "0.7rem",
            fontWeight: "800",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            {blogs.map((post, i) => (
              ...
              >
                ...
                <div style={{ height: "1px", background: "rgba(218,160,109,0.12)", marginBottom: "0.85rem" }} />
